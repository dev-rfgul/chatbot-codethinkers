...
const pattern = [
  ...
  {
    pattern: /who\s+are\s+you|your\s+name|tell\s+me\s+about\s+yourself|introduce\s+yourself/i,
    answer: "Hello! I'm **Muhammad Fahad**, a **Junior Software Engineer** and **MERN Stack** professional. I have experience working as a **Web Developer**  with expertise in both frontend and backend technologies."
  },
  
  // Contact Information
  {
    pattern: /phone|mobile|number|call/i,
    answer: "You can reach me at **03329296026** on whatsapp for any inquiries or project discussions."
  },
  ...
  {
    pattern: /social\s+media|socials?|connect\s+on|follow\s+me|social\s+platforms|where\s+can\s+i\s+find\s+you/i,
    answer: "You can connect with me on various platforms:\n\n- 💼 [LinkedIn](https://www.linkedin.com/in/rf-gul/) - Professional networking\n- 💻 [GitHub](https://github.com/dev-rfgul) - Code repositories\n- 🌐 [Portfolio](https://devrfgul.vercel.app/) - Complete work showcase\n- 📧 **Email** - [devrfgul@gmail.com](mailto:devrfgul@gmail.com)\n- 💬 **WhatsApp** - [03329296026](https://wa.me/923329296026)\n\nWhich specific platform would you like to connect on?"
  },
  
  // Specific Social Media Platforms
  {
    pattern: /linkedin|professional\s+network/i,
    answer: "You can connect with me on [LinkedIn](https://www.linkedin.com/in/rf-gul/) for professional networking and updates about my career journey in full-stack development!"
  },
  
  {
    pattern: /github|git\s+hub|code\s+repository|source\s+code/i,
    answer: "Check out my [GitHub profile](https://github.com/dev-rfgul) to see my code repositories, contributions, and all the projects I've worked on. You'll find *live demos* and *source code* for all my projects there!"
  },
  
  {
    pattern: /portfolio|website|personal\s+site/i,
    answer: "Visit my [Portfolio website](https://devrfgul.vercel.app) to see my complete work showcase, projects, skills, and professional journey. It's the best place to get a comprehensive view of my capabilities!"
  },
  ...
  {
    pattern: /learning|currently\s+learning|studying|what\s+are\s+you\s+learning/i,
    answer: "I'm continuously learning and improving my skills in:\n\n- Cloud Computing **AWS**\n-  **Django** backend development\n- Exploring new technologies and techniques in the **MERN stack** ecosystem"
  },
  ...
  // Frontend Skills
{
  pattern: /frontend|front.end|react|javascript|html|css|tailwind|jquery|next|angular/i,
  answer: `## Frontend Skills
...
{
  pattern: /backend|back.end|node|mongo|express|django|database|sql/i,
  answer: `## Backend Skills
...
**Project-Based Frontend Developer** – Freelance  
Nov 2024–Feb 2025

**Junior Software Engineer** – Aitch Tech  
Current
...
### 1. Ecom Website
WordPress to MERN conversion with significant performance improvement.

### 2. Task Manager AI
Advanced productivity tool with AI-powered task assistance and organization.

### 3. University Bus Management System
A full-stack system for managing university bus routes, schedules, and student registrations.
...
`
  ...
  {
    pattern: /contact|hire|available|reach\s+out|connect/i,
    answer: "## Let's Connect!\n\nI'm available for full-stack development projects!\n\n### Contact Methods\n- 📧 **Email:** [devrfgul@gmail.com](mailto:devrfgul@gmail.com)\n- 💬 **WhatsApp:** [03329296026](https://wa.me/923329296026)\n- 💼 **LinkedIn:** [Connect with me](https://www.linkedin.com/in/YOUR_LINKEDIN_USERNAME)\n- 💻 **GitHub:** [View my code](https://github.com/YOUR_GITHUB_USERNAME)\n- 🌐 **Portfolio:** [Visit my website](https://your-portfolio-url.com)\n\nI'm always responsive and ready to discuss new opportunities! 🚀"
  },
...
My main focus is to grow as a Full Stack Developer and strengthen my backend and cloud fundamentals.

My long-term learning path includes:
- Becoming a strong Full Stack Developer
- Learning Cloud Computing
- Mastering AWS services
